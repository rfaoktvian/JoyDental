                ...
                function section($title, $updated = null, $rows = [])
                {
                    ...
                    foreach ($rows as $row) {
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="fw-medium mb-0">' . $row[1] . '</p>
                        </div>';
                    }
                    echo '</div></div>';
                }
        ...
        <form class="modal-content" method="POST" action="#">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="patientEmail" name="email" value="willie.jennings@mail.com">
                </div>
                <div class="mb-3">
                    <label for="patientPhone" class="form-label">No. HP</label>
                    <input type="text" class="form-control" id="patientPhone" name="phone" value="(302) 555-0107">
                </div>
                <div class="mb-3">
