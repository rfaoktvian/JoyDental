...
@section('content')
    <style>
        ...
        /* Mengubah warna tombol .btn-danger */
        .btn-danger {
            background-color: #6B2C91 !important;  /* Mengubah warna background tombol */
            border-color: #6B2C91 !important;  /* Mengubah warna border tombol */
        }

        /* Mengubah warna border dan background saat tombol .btn-danger di-hover */
        .btn-danger:hover {
            background-color: #4F206B !important;  /* Warna background saat hover */
            border-color: #6B2C91 !important;  /* Warna border saat hover */
        }
    </style>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-center align-items-center rounded-circle me-3"
                                    style="width: 45px; height: 45px; background-color: #ffe6ffff;">
