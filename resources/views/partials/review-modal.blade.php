<div class="modal fade" id="reviewModal-{{ $id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content border-0 shadow-sm rounded-3">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-semibold">
                    Ulasan untuk Dr. {{ $name }}
                </h5>
            ...
            <div class="modal-body">
                @forelse ($reviews as $review)
                    <div class="review-item d-flex gap-3 p-3 rounded-3 mb-3 shadow-sm bg-white hover-shadow-sm">
                        <img src="{{ asset('images/doctors_dashboard.png') }}" alt="User Photo" class="rounded-circle"
