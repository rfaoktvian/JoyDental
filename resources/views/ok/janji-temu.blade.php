                    ...
                    <div class="card-body p-4">
                        <form id="appointmentForm" action="" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="mb-4">
                                    <label for="polyclinic" class="form-label fw-bold">Daftar Poliklinik <span
                                    ...
                                    <select class="form-select form-select-lg @error('polyclinic') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('polyclinic') == '1' ? 'selected' : '' }}>Klinik Anak
                                            (Pediatric)</option>
                                        <option value="2" {{ old('polyclinic') == '2' ? 'selected' : '' }}>Klinik
                                            Dokter Gigi (Surgical)</option>
                                        <option value="3" {{ old('polyclinic') == '3' ? 'selected' : '' }}>Klinik Bedah
                                            Mulut (Surgical)</option>
                                        <option value="4" {{ old('polyclinic') == '4' ? 'selected' : '' }}>Klinik
                                            Penyakit Dalam (Internal Medicine)</option>
                                        <option value="5" {{ old('polyclinic') == '5' ? 'selected' : '' }}>Klinik Mata
                                            (Ophthalmology)</option>
                                        <option value="6" {{ old('polyclinic') == '6' ? 'selected' : '' }}>Klinik
                                            Jantung (Cardiology)</option>
                                    </select>
                                    @error('polyclinic')
                            ...
                            <div class="mb-5">
                                ...
                                <div class="mb-4">
                                    <label for="doctor" class="form-label fw-bold">Dokter yang Tersedia <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select form-select-lg @error('doctor') is-invalid @enderror"
                                        id="doctor" name="doctor" required>
                                        <option value="" selected disabled>Pilih Dokter</option>
                                        <option value="1" data-specialty="Pediatric" data-experience="12"
                                            data-schedule="Sel, Kam" data-time="09:00 - 14:00" data-price="225000"
                                            {{ old('doctor') == '1' ? 'selected' : '' }}>
                                            Dr. Amanda Wijaya - Spesialis Pediatric (12 tahun pengalaman) - Rp 225.000
                                        </option>
                                        <option value="2" data-specialty="Surgical" data-experience="10"
                                            data-schedule="Sel, Kam" data-time="10:00 - 15:00" data-price="235000"
                                            {{ old('doctor') == '2' ? 'selected' : '' }}>
                                            Dr. Jason Santoso - Spesialis Surgical (10 tahun pengalaman) - Rp 235.000
                                        </option>
                                        <option value="3" data-specialty="Pediatric" data-experience="8"
                                            data-schedule="Sen, Rab, Jum" data-time="13:00 - 17:00" data-price="210000"
                                            {{ old('doctor') == '3' ? 'selected' : '' }}>
                                ...
                                <div id="doctor-info" class="card bg-light d-none mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="mb-1"><strong>Spesialisasi:</strong> <span
                                                        id="doctor-specialty">-</span></p>
                                                <p class="mb-1"><strong>Pengalaman:</strong> <span
                                                        id="doctor-experience">-</span> tahun</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-1"><strong>Jadwal:</strong> <span
                                                        id="doctor-schedule">-</span></p>
                                                <p class="mb-1"><strong>Jam Praktek:</strong> <span
                                                        id="doctor-time">-</span></p>
                                            </div>
                                        </div>
                                        <p class="mb-0 text-success"><strong>Biaya Konsultasi: Rp <span
                                                    id="doctor-price">-</span></strong></p>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label for="visit_date" class="form-label fw-bold">Tanggal Kunjungan <span
                                            class="text-danger">*</span></label>
                                    <input type="date"
                                        class="form-control form-control-lg @error('visit_date') is-invalid @enderror"
                            ...
                            <div class="mb-5">
                                        ...
                                        <div class="card border-success">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h5 class="card-title mb-1">{{ Auth::user()->name ?? 'Walidddd' }}
                                                        </h5>
                                                        <p class="card-text mb-1">NIK:
                                                            {{ Auth::user()->nik ?? '3173011509950001' }}</p>
                                                        <p class="card-text mb-0">
                                                            {{ Auth::user()->gender ?? 'Laki-laki' }},
                                                            {{ Auth::user()->age ?? '30' }} tahun</p>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" name="patient_gender">
                                                    ...
                                                    <option value="L"
                                                        {{ old('patient_gender') == 'L' ? 'selected' : '' }}>Laki-laki
                                                    </option>
                                                    <option value="P"
                                                        {{ old('patient_gender') == 'P' ? 'selected' : '' }}>Perempuan
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('complaint') is-invalid @enderror" rows="4" name="complaint"
                                        placeholder="Deskripsikan keluhan Anda secara detail..." required>{{ old('complaint') }}</textarea>
                                    @error('complaint')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="mb-4">
                                    <label for="payment_method" class="form-label fw-bold">Pilih Metode Pembayaran <span
                                            class="text-danger">*</span></label>
                                    <select
                                        ...
                                        <option value="rujuk_internal"
                                            {{ old('payment_method') == 'rujuk_internal' ? 'selected' : '' }}>
                                            <i class="fas fa-credit-card"></i> Rujuk Internal
                                        </option>
                                        <option value="jasa_raharja"
                                            {{ old('payment_method') == 'jasa_raharja' ? 'selected' : '' }}>
                                            <i class="fas fa-money-bill-wave"></i> PT. Jasa Raharja
                                        </option>
                                        <option value="inhealt"
                                            {{ old('payment_method') == 'inhealt' ? 'selected' : '' }}>
                                            <i class="fas fa-building"></i> Inhealt
                                        </option>
                                        <option value="kereta_api"
                                            {{ old('payment_method') == 'kereta_api' ? 'selected' : '' }}>
                            ...
                            <div class="alert alert-info d-flex align-items-start mb-4" role="alert">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Pasien setelah mendaftar diharap untuk datang 15 menit sebelum waktu
                                        yang telah ditentukan.
                                        Jika pasien tidak hadir dalam waktu 30 menit setelah waktu yang ditentukan, maka
                                        janji temu akan dibatalkan secara otomatis.</p>
                                </div>
                            </div>
                            ...
                            <div class="card border-primary mb-4">
                                <div class="card-header bg-primary text-white">
                                    <h5 class="card-title mb-0"><i class="fas fa-clipboard-list me-2"></i>Ringkasan
                                        Pemesanan</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <dl class="row mb-0">
                                                ...
                                                <dd class="col-sm-7" id="summary-patient">
                                                    {{ Auth::user()->name ?? 'Walidddd' }}</dd>
