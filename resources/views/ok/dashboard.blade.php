...
@section('content')
    ...
    <div class="banner-enhanced position-relative p-4 text-white d-flex align-items-center justify-content-between mb-5"
        style="height: 280px;">
        ...
        <div class="position-relative" style="z-index: 2;">
            <img src="{{ asset('images/doctors_dashboard.png') }}" alt="Doctors" class="pulse-animation"
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3 pt-3 border-top">
                            ...
                            <button class="btn btn-outline-secondary btn-sm ms-2" data-bs-toggle="modal"
                                data-bs-target="#printPrescriptionModal">
    ...
    <div class="modal fade" id="consultationDetailModal" tabindex="-1" aria-labelledby="consultationDetailModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-success mb-3"><i class="fas fa-clipboard-check me-2"></i>Detail Konsultasi
                            </h6>
                            <table class="table table-borderless">
                                <tr>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="bg-light p-3 rounded">Pasien disarankan untuk mengurangi konsumsi garam, rutin
                            berolahraga ringan, dan kontrol rutin setiap 2 minggu.</p>
                    </div>
                </div>
    ...
    <div class="modal fade" id="printPrescriptionModal" tabindex="-1" aria-labelledby="printPrescriptionModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="fas fa-exclamation-triangle text-warning me-2"></i>Hindari makanan tinggi garam
                            </li>
                            <li><i class="fas fa-info-circle text-info me-2"></i>Minum obat pada waktu yang sama setiap
                                hari</li>
