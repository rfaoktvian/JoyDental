                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $doctor->name ?? 'Dr. Ahmad Susanto' }}" name="name"
                                                        required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="tel" class="form-control"
                                                        value="{{ $doctor->phone ?? '+62 812-3456-7890' }}" name="phone"
                                                        required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        value="{{ $doctor->experience ?? 8 }}" name="experience"
                                                        min="0">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div id="scheduleContainer">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="20"
                                                        placeholder="Kuota" name="monday_quota">
                                                </div>
                                                <div class="col-md-1">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="20"
                                                        placeholder="Kuota" name="tuesday_quota">
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm btn-outline-secondary"
                                                        onclick="toggleSchedule(this)">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="20"
                                                        placeholder="Kuota" name="thursday_quota">
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm btn-outline-secondary"
                                                        onclick="toggleSchedule(this)">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="20"
                                                        placeholder="Kuota" name="friday_quota">
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm btn-outline-secondary"
                                                        onclick="toggleSchedule(this)">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label fw-semibold"
                                                            for="saturday">Sabtu</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="time" class="form-control" value="08:00"
                                                        name="saturday_start" disabled>
                                                </div>
                                                <div class="col-md-1 text-center">
                                                    <span class="text-muted">sampai</span>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="time" class="form-control" value="13:00"
                                                        name="saturday_end" disabled>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="15"
                                                        placeholder="Kuota" name="saturday_quota" disabled>
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm btn-outline-secondary"
                                                        onclick="toggleSchedule(this)">
                                            ...
                                            <div class="row align-items-center mb-3 schedule-row">
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label fw-semibold"
                                                            for="sunday">Minggu</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="time" class="form-control" value="09:00"
                                                        name="sunday_start" disabled>
                                                </div>
                                                <div class="col-md-1 text-center">
                                                    <span class="text-muted">sampai</span>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="time" class="form-control" value="14:00"
                                                        name="sunday_end" disabled>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control" value="10"
                                                        placeholder="Kuota" name="sunday_quota" disabled>
                                                </div>
                                                <div class="col-md-1">
                                                    <button class="btn btn-sm btn-outline-secondary"
                                                        onclick="toggleSchedule(this)">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <div id="photoPreview" class="mb-3">
                                                <img src="{{ asset('images/doctors_login.png') }}" alt="Preview"
                                            ...
                                            <small class="text-muted d-block mt-2">Format: JPG, PNG, GIF. Maksimal
                                                2MB</small>
                                        </div>
