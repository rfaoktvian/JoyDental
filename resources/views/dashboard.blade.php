...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-12 col-lg-10 px-4 py-3" id="content-wrapper">
      {{-- Banner --}}
      <div class="banner position-relative p-4 rounded text-white d-flex align-items-center justify-content-between overflow-hidden mb-5"
      ...
      {{-- Search Bar --}}
      <div class="search-bar bg-white shadow-sm rounded-pill p-2 d-flex align-items-center justify-content-between mx-auto mb-5"
        style="max-width: 600px; margin-top: -2rem;">
        <input type="text"
          class="form-control border-0 rounded-pill me-2"
          placeholder="Pencarian Poliklinik" />
