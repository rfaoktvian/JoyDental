...
@section('content')
  ...
  <div class="main-content">
    ...
    <!-- Header -->
    <header class="bg-danger text-white text-center py-5 mb-3 rounded-2">
      <h2 class="fw-bold">Daftar Poliklinik Kami</h2>
    ...
    <section class="container-fluid">
      ...
      <div class="col-md-4 mb-4">
        ...
        <div class="card-body">
          ...
          <img src="hospital.svg" alt="Ikon Hospital" width="45" height="45"
      ...
      <div class="col-md-4 mb-4">
        ...
        <div class="card-body">
          ...
          <img src="hospital.svg" alt="Ikon Hospital" width="45" height="45"
            class="rounded-circle me-3 bg-danger">
          <div>
            <h6 class="mb-0">Klinik Bedah Mulut</h6>
            <small>Gedung Cokro Aminoto Lt.3</small><br />
