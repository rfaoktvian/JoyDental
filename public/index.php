...
<head>
    ...
    <title>AppointDoc - Temukan Dokter Terbaik</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container text-black">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="lead mb-4">
                        AppointDoc membantu Anda menemukan dan menjadwalkan konsultasi 
    ...
    <section id="features" class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Kenapa Memilih AppointDoc?</h2>
            <div class="row">
                <div class="col-md-4 text-center">
                    <i class="fas fa-calendar-check fa-3x text-primary mb-3"></i>
                    <h4>Mudah Booking</h4>
                    <p>Jadwalkan konsultasi kapan saja dan di mana saja</p>
                </div>
                <div class="col-md-4 text-center">
                    <i class="fas fa-user-md fa-3x text-primary mb-3"></i>
                    <h4>Dokter Profesional</h4>
                    <p>Dokter berpengalaman dan tersertifikasi</p>
                </div>
                <div class="col-md-4 text-center">
                    <i class="fas fa-video fa-3x text-primary mb-3"></i>
                    <h4>Konsultasi Fleksibel</h4>
                    <p>Online, offline, atau video conference</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text">Konsultasi dengan dokter melalui video call atau chat</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Janji Temu Offline</h5>
                            <p class="card-text">Kunjungi dokter secara langsung di rumah sakit atau klinik</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text">Simpan dan kelola riwayat kesehatan Anda secara digital</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.270756540308!2d109.24651767363716!3d-7.4352630925755525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655ea49d9f9885%3A0x62be0b6159700ec9!2sTelkom%20Purwokerto%20University!5e0!3m2!1sid!2sid!4v1743670629696!5m2!1sid!2sid" width="350" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-md-4">
                    <h5>Menu Utama</h5>
                    <ul class="list-unstyled">
                        <li><a href="#dashboard" class="text-white">Beranda</a></li>
